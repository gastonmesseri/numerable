...
import addThousandsSeparatorToValueIntegerPart from '../../src/formatter/format/number-to-formatted-number/utils/add-thousands-separator-to-value-integer-part';
